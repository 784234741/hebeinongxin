    ...
    >
      <template slot="tableColumn">
        ...
        <el-table-column label="本月新增开户数量" align="center">
          <el-table-column prop="enterprise_num" label="企业（含非法人企业）">
            <div slot-scope="{ row }">
              <span>{{ row.enterprise_num }}</span>
            </div>
          </el-table-column>
        ...
        <el-table-column label="1月至本月新增开户数量" align="center">
          <el-table-column prop="enterprise_num_sum" label="企业（含非法人企业）">
            <div slot-scope="{ row }">
              <span>{{ row.enterprise_num_sum }}</span>
            </div>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      exportXlsx(tHeader, data, '企业开户率监测统计表')
    },
    /**
     * 加载中动画配置*/
    showLoading() {
